...
namespace KeePassLib.Utility
{
    ...
    public static class StrUtil
    {
        ...
        public static bool TryParseUShort(string str, out ushort u) => ushort.TryParse(str, out u);

        public static bool TryParseInt(string str, out int n) => int.TryParse(str, out n);

        public static bool TryParseIntInvariant(string str, out int n) => int.TryParse(str, NumberStyles.Integer, NumberFormatInfo.InvariantInfo, out n);

        public static bool TryParseUInt(string str, out uint u) => uint.TryParse(str, out u);

        public static bool TryParseUIntInvariant(string str, out uint u) => uint.TryParse(str, NumberStyles.Integer, NumberFormatInfo.InvariantInfo, out u);

        public static bool TryParseLong(string str, out long n) => long.TryParse(str, out n);

        public static bool TryParseLongInvariant(string str, out long n) => long.TryParse(str, NumberStyles.Integer, NumberFormatInfo.InvariantInfo, out n);
        ...
        public static int[] DeserializeIntArray(string strSerialized)
        {
            ...
            if (strSerialized.Length == 0) return Array.Empty<int>();
